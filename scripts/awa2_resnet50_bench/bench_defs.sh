...
BENCH_PARAMS[MixedDatasets]="train_dataset=awa2_train_mixed train_dataset.dataset_split='train' eval_dataset=awa2_test_mixed_main +adv_dataset=imagenet_sketch device=cuda:1"
