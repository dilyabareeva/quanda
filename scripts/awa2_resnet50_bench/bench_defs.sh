...
BENCH_PARAMS[ClassDetection]="train_dataset=awa2_train train_dataset.dataset_split='train' eval_dataset=awa2_test device=cuda:0"
BENCH_SWEEP[ClassDetection]=""

BENCH_PARAMS[SubclassDetection]="model=awa2_resnet50_subclass train_dataset=awa2_train_subclass train_dataset.dataset_split='train' eval_dataset=awa2_test_subclass val_dataset=awa2_val_subclass device=cuda:0"
...
BENCH_SWEEP[MixedDatasets]="model.trainer.max_epochs=64,96 splits.imagenet_sketch.ratios.train=0.01,0.02 hydra.sweeper.n_trials=24"
...
BENCH_SWEEP[ShortcutDetection]="model.trainer.max_epochs=64,96 train_dataset.wrapper.metadata.p=0.75,0.85 hydra.sweeper.n_trials=36"
