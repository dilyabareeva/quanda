...
EXPL_SWEEP[similarity]="explainer.kwargs.layers=fc_2,fc_3 device=cuda:0"
EXPL_SWEEP[representer_points]="explainer.kwargs.features_layer=relu_4 device=cuda:0"
