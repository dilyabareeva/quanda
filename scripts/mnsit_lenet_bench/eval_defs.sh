...
EXPL_SWEEP[representer_points]="explainer.kwargs.features_layer=relu_3,relu_4 explainer.kwargs.normalize=true,false device=cuda:0"
EXPL_SWEEP[tracincpfast]="device=cuda:0"
EXPL_SWEEP[arnoldi]="explainer.kwargs.projection_dim=50,10 explainer.kwargs.arnoldi_dim=100,200 device=cuda:0  explainer.kwargs.layers=[fc_2],[fc_3],[fc_1,fc_2,fc_3]"
