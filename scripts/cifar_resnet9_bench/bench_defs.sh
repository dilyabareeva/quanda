...
BENCH_PARAMS[MixedDatasets]="train_dataset=cifar10_train train_dataset.dataset_split='train' eval_dataset=cifar10_test_mixed_main eval_dataset.dataset_split='test' +adv_dataset=svhn +filter_by_prediction=true device=cuda:0"
...
BENCH_PARAMS[ShortcutDetection]="train_dataset=cifar10_train_shortcut train_dataset.dataset_split='train' eval_dataset=cifar10_test_shortcut eval_dataset.dataset_split='test' +filter_by_shortcut_pred=true +filter_by_non_shortcut=true val_dataset=cifar10_val_shortcut device=cuda:0"
...
BENCH_PARAMS[MislabelingDetection]="train_dataset=cifar10_train_mislabeling train_dataset.dataset_split='train' eval_dataset=cifar10_test eval_dataset.dataset_split='test' device=cuda:0"
...
BENCH_PARAMS[LDS]="train_dataset=cifar10_train train_dataset.dataset_split='train' eval_dataset=cifar10_test eval_dataset.dataset_split='test' device=cuda:0"
BENCH_SWEEP[LDS]=""
