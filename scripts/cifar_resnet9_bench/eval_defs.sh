...
EXPL_SWEEP[representer_points]="explainer.kwargs.features_layer=model.8 explainer.kwargs.classifier_layer=model.9 device=cuda:0 explainer.kwargs.normalize=true,false  hydra.launcher.n_jobs=2"
...
EXPL_SWEEP[trak]="explainer.kwargs.proj_dim=1024,2048 device=cuda:0  hydra.launcher.n_jobs=2"
