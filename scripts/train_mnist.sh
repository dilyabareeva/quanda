...
bench_params=(
    ...
    "train_dataset=mnist_train_shortcut train_dataset.dataset_split='train' eval_dataset=mnist_test_shortcut eval_dataset.dataset_split='test' +filter_by_class=true +filter_by_non_shortcut=true model.trainer.max_epochs=5"
