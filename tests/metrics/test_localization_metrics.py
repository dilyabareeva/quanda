...
from src.metrics.localization.subclass_detrection import SubclassDetection
...
def test_identical_class_metrics(
    ...
    metric = ClassDetection(model=model, train_dataset=dataset, device="cpu")
