...
def load_mnist_unit_test_config():
    # load yaml file
    with open(
        "tests/assets/mnist_test_suite_2/a99e9fe-default_ClassDetection.yaml",
        "r",
    ) as f:
...
def load_mnist_mislabeling_config():
    # load yaml file
    with open(
        "tests/assets/mnist_test_suite_2/a99e9fe-default_MislabelingDetection.yaml",
        "r",
    ) as f:
        config = yaml.safe_load(f)
    return config
...
def load_mnist_subclass_config():
    # load yaml file
    with open(
        "tests/assets/mnist_test_suite_2/a99e9fe-default_SubclassDetection.yaml",
        "r",
    ) as f:
        config = yaml.safe_load(f)
    return config
...
def load_mnist_shortcut_config():
    # load yaml file
    with open(
        "tests/assets/mnist_test_suite_2/a99e9fe-default_ShortcutDetection.yaml",
        "r",
    ) as f:
        config = yaml.safe_load(f)
    return config
...
def load_mnist_mixed_config():
    # load yaml file
    with open(
        "tests/assets/mnist_test_suite_2/a99e9fe-default_MixedDatasets.yaml",
        "r",
    ) as f:
        config = yaml.safe_load(f)
    return config
