...
The evaluation of TDA methods is a difficult task, especially due to the computationally demanding and noisy nature of the ground truths. (`Basu et al., 2021 <https://arxiv.org/abs/2006.14651>`__; `Nguyen et al., 2023 <https://arxiv.org/abs/2305.19765>`__). For this reason, the community has proposed various sanity checks (`Hanawa et al., 2021 <https://openreview.net/forum?id=9uvhpyQwzM_>`__) and downstream tasks (`Koh and Liang, 2017 <https://proceedings.mlr.press/v70/koh17a.html>`__; `Khanna et al., 2019 <https://proceedings.mlr.press/v89/khanna19a.html>`__; `Karthikeyan et al., 2021 <https://arxiv.org/abs/2111.04683>`__) to evaluate the effectiveness of TDA methods. Quanda provides a unified framework to evaluate TDA methods to help researchers and practitioners choose between the proposed methods.
