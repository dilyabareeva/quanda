...
config_map: dict = {
    ...
    "0921427-default_SubclassDetection.yaml",
    "mnist_mixed_datasets_unit": "tests/assets/mnist_test_suite_3/"
    "0921427-default_MixedDatasets.yaml",
    "mnist_mislabeling_detection_unit": "tests/assets/mnist_test_suite_3/"
    "0921427-default_MislabelingDetection.yaml",
    "mnist_shortcut_detection_unit": "tests/assets/mnist_test_suite_3/"
    "0921427-default_ShortcutDetection.yaml",
    "mnist_class_detection_unit": "tests/assets/mnist_test_suite_3/"
    "0921427-default_ClassDetection.yaml",
    "mnist_model_randomization_unit": "tests/assets/mnist_test_suite_3/"
    "0921427-default_ClassDetection.yaml",
    "mnist_top_k_cardinality": files("quanda.benchmarks.resources.configs").joinpath(
    "7b6c898-default_ClassDetection.yaml"),
    "mnist_subclass_detection": files("quanda.benchmarks.resources.configs").joinpath(
    "7b6c898-default_SubclassDetection.yaml"),
    "mnist_mixed_datasets": files("quanda.benchmarks.resources.configs").joinpath(
    "7b6c898-default_MixedDatasets.yaml"),
    "mnist_mislabeling_detection": files("quanda.benchmarks.resources.configs").joinpath(
    "7b6c898-default_MislabelingDetection.yaml"),
    "mnist_shortcut_detection": files("quanda.benchmarks.resources.configs").joinpath(
    "7b6c898-default_ShortcutDetection.yaml"),
    "mnist_class_detection": files("quanda.benchmarks.resources.configs").joinpath(
    "7b6c898-default_ClassDetection.yaml"),
    "mnist_model_randomization": files("quanda.benchmarks.resources.configs").joinpath(
    "7b6c898-default_ClassDetection.yaml"),
}
